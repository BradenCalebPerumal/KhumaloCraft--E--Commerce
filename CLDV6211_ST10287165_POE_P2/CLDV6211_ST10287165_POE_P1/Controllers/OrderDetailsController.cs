...
namespace CLDV6211_ST10287165_POE_P1.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(CLDV6211_ST10287165_POE_P1Context context)
        {
            _context = context;
        }
        ...
        {
            var cLDV6211_ST10287165_POE_P1Context = _context.OrderDetails.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> Create([Bind("OrderDetailId,OrderId,ProductId,Quantity,Price")] OrderDetail orderDetail)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Product, "Id", "ImageType", orderDetail.ProductId);
            return View(orderDetail);
        }
        ...
        public async Task<IActionResult> ClientOrders()
        {
            ...
            var clientOrders = await _context.OrderDetails
                .Include(od => od.Product)
                .Include(od => od.Order)
                .Where(od => od.Product.ClientId == clientId)
                .ToListAsync();
